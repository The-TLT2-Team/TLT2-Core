...
@JeiPlugin
public class TltCoreJeiCompat implements IModPlugin {

    public static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath(TltCore.MODID, "main");
    ...
    public void registerRecipes(IRecipeRegistration registration) {
        registration.addRecipes(LOOT.getRecipeType(), List.of(new CursedRingLootRecipe()));
