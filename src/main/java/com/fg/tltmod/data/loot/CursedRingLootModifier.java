package com.fg.tltmod.data.loot;
...
public class CursedRingLootModifier extends LootModifier {
    public static final Codec<CursedRingLootModifier> CODEC = RecordCodecBuilder.create(instance -> codecStart(instance)
            .apply(instance, CursedRingLootModifier::new));

    public CursedRingLootModifier(LootItemCondition... conditionsIn) {
        super(conditionsIn);
    }
    ...
    @Override
    public Codec<CursedRingLootModifier> codec() {
        return CODEC;
    }
