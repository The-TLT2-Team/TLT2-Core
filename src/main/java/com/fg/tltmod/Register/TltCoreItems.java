...
import com.fg.tltmod.content.item.*;
...
public class TltCoreItems {
    ...
    public static final RegistryObject<Item> NEUTRON_ARROW = BASIC_ITEM.register("neutron_arrow", NeutronArrowItem::new);
    public static final RegistryObject<Item> LASER_ARROW = BASIC_ITEM.register("laser_arrow", LaserBeamArrowItem::new);
